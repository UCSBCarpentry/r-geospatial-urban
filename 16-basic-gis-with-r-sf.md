...
``` error
Error:
! object 'old_buildings' not found
```
...
``` error
Error:
! object 'buffer_old_buildings' not found
```
...
``` error
Error:
! object 'single_old_buffer' not found
```
...
``` error
Error:
! object 'centroids_old' not found
```
...
``` error
Error:
! object 'centroids_buffers' not found
```
...
``` error
Error:
! object 'single_buffer' not found
```
